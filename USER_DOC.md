...
This document contains the instructions for end users and administrators on how to use and manage the Inception web infrastructure.
...
### 1. **NGINX Web Server**
- **Role**: Manages incoming HTTPS requests and serves as a reverse proxy
- **Functionalties**: 
...
### 2. **WordPress**
- **Role**: Content Management System (CMS) for creating and managing website content
- **Features**:
